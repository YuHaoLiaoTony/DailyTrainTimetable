...
public static class Program
{
    ...
    internal static async Task<string> GetAccessTokenAsync(HttpClient httpClient, string clientId, string clientSecret)
    {
    ...
    internal static async Task<DailyTrainData> FetchDailyDataAsync(
    ...
    internal static async Task<HttpResponseMessage> SendDailyTimetableRequestWithRetryAsync(HttpClient httpClient, string trainDate)
    {
        var retryDelays = new[]
        {
    ...
    internal static TimeSpan GetRetryDelay(HttpResponseMessage response, TimeSpan fallbackDelay)
    {
    ...
    internal static IEnumerable<JsonElement> GetTimetableItems(JsonElement root)
    {
    ...
    internal static List<StopTime> ReadStopTimes(JsonElement timetable, IDictionary<string, Station> stationMap)
    {
    ...
    internal static string? GetString(JsonElement element, params string[] propertyNames)
    {
    ...
    internal static string? GetName(JsonElement element, string propertyName)
    {
        if (!element.TryGetProperty(propertyName, out var value))
        {
            return null;
    ...
    internal static async Task WriteJsonAtomicallyAsync<T>(string path, T value, JsonSerializerOptions options)
    {
